...
export default class Shot extends Component {
    ...
    render() {
        return (
            <div className="container-fluid" id="shot">
                <div className="">

                </div>
                <div className="text-center">
                    <h6 className="section-heading text-uppercase subjudul">Special Offer</h6>
                    <h2 className="section-heading text-uppercase judul">Featured Products
                ...
                <div className="row">
                    {this.state.product.slice(0, 3).map(this.loopItem)}  
                </div>
            </div>
